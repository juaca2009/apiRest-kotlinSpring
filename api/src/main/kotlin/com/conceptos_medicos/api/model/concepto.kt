...
@Entity
@Table(name = "concepto")
data class concepto(val PXORDX:String = "", val OLDPXORDX:String = "", val CODETYPE:String = "", val CONCEPT_CLASS_ID:String = "", val CONCEPT_ID:String = "", val VOCABULARY_ID:String = "", val DOMAIN_ID:String = "", val TRACK:String = "", val STANDARD_CONCEPT:String = "", 
